...
def main():
	...
	print('\033[1;32m        ┌─────────────────────────────────┐') 
	print("\033[1;92m\t│\033[1;92mWELLCOME TO   𝐓𝐄𝐅 𝐊𝐀𝐖𝐒𝐀𝐑 \033[1;92m      │")
	print('\033[1;32m┌────────────────────────────────────────────┐') 
...
banner = """   
 ...
 |__   __|  ____|  ____|
    ...
    |_|  |______|_|                                                                               
=================================================
    [-] AUTHOR    :\033[1;32m  𝐓𝐄𝐀𝐌 𝐄𝐑𝐑𝐎𝐑 𝐅𝐈𝐑𝐄 
    [-] GITHUB    :\033[1;32m kawsar58
    [-] WhatsApp  :\033[1;32m +8801317065894
...
def xoshnaw():
	...
	try:
		...
		if id in httpCaht:
			...
			os.system('xdg-open https://youtube.com/@tarchbd')
			time.sleep(1)
			sys.exit()
	except:
		sys.exit()
